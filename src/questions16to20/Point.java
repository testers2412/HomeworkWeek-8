...
public class Point {
    int x,y;
    public Point(){}//zero arg constructor
    public Point(int x,int y){// two args constructor. Constructor overloading
        this.x= x;//assigning local variable to instance(global) variable
        this.y=y;
    }
    public int getX(){//getter's method
        return x;
    }
    public int getY(){
        return y;
    }
    public void setX(int x){//setter's method
        this.x=x;
    }
    ...
    public double distance(int x, int y){//method overloading
        return Math.sqrt((x-getX())* (x-getX()) + (y-getY()) * (y-getY()));

    }
    public double distance(Point another){//Encapsulation of class and variable and method overloading
